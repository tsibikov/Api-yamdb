# Generated by Django 3.0.5 on 2020-09-08 09:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('moderator', 'Модератор'), ('user', 'Пользователь')], default='user', max_length=10, verbose_name='Роль пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(blank=True, null=True, related_name='genres', to='api.Genre')),
            ],
            options={
                'ordering': ('-pk',),
            },
